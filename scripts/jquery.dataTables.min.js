...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordenar ascendente",sSortDescending:": activar para ordenar descendente"},oPaginate:{sFirst:"Primero",sLast:"Ultimo",
sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay datos disponibles para mostrar",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 entradas",sInfoFiltered:"(filtradas _MAX_  entradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrando _MENU_",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscando:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No hay datos que coincidan"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
