...
<body>
  <!-- NAVBAR -->
  <div class="d-flex position-sticky z-index-sticky justify-content-center">
    <!-- PERFIL NAV -->
    <nav class="navbar m-2 rounded navbar-light bg-white">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-auto">
              <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" height="35" fill="currentColor" class="bi bi-door-closed" viewBox="0 0 16 16">
