        ...
        <div class='row justify-content-center mt-5'>
            <div class='col-sm-6'>
                <div class='text-center text-light'>
                    <form id="formLogin" class='card gradiente shadow border-0 m-3 p-5' action="../php/auth-login.php" method="POST">
                        <h1>Login</h1>
            ...
            <div class='col-sm-6'>
                <div class='text-center text-light'>
                    <form id="formRegister" class='card bg-gradiente-invertido shadow border-0 m-3 p-5' action="../php/insert-register.php" method="POST">
                        ...
                        <input class='mt-3 shadow-sm text-center btn btn-light' type='submit' value='Registrarse'>
